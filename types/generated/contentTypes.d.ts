...
export interface ApiBrandBrand extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    LogoURL: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    products: Schema.Attribute.Relation<'oneToMany', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    specification_types: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiPhonePhone extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dailcode: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    specification_values: Schema.Attribute.Relation<
      'manyToMany',
      'api::specification-value.specification-value'
    >;
...
export interface ApiSpecificationValueSpecificationValue
  extends Struct.CollectionTypeSchema {
  collectionName: 'specification_values';
  info: {
    displayName: 'Specification Value';
    pluralName: 'specification-values';
    singularName: 'specification-value';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    products: Schema.Attribute.Relation<'manyToMany', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    specification_type: Schema.Attribute.Relation<
      'manyToOne',
      'api::specification-type.specification-type'
    >;
    updatedAt: Schema.Attribute.DateTime;
